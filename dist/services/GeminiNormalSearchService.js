...
exports.GeminiNormalSearchService = void 0;
const axios_1 = __importDefault(require("axios"));
class GeminiNormalSearchService {
    constructor() {
...
\`\`\``;
     ...
     */
    async executeNormalSearch(request) {
        try {
...
exports.GeminiNormalSearchService = GeminiNormalSearchService;
//# sourceMappingURL=GeminiNormalSearchService.js.map