...
exports.GeographicMatching = void 0;
...
class GeographicMatching {
     ...
     */
    calculateGeographicScore(context) {
     ...
     */
    calculateCountryRelationship(searchCountry, entityCountries) {
        ...
        const hasRegionalMatch = entityCountries.some(country => searchRegionalCountries.includes(country));
        if (hasRegionalMatch) {
            const matchedRegionalCountries = entityCountries.filter(country => searchRegionalCountries.includes(country));
            return {
                relevance_score: 0.8,
     ...
     * Apply search radius modifiers
     */
    applySearchRadiusModifier(score, radius) {
     ...
     */
    filterByGeographicRelevance(entities, context, minRelevanceScore = 0.5) {
        return entities
            .map(entity => {
     ...
     */
    getGeographicSuggestions(location, entityCountries) {
     ...
     */
    applyGeographicDeduplication(results, maxPerCountry = 3) {
...
exports.GeographicMatching = GeographicMatching;
//# sourceMappingURL=GeographicMatching.js.map