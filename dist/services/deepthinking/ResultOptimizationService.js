...
exports.ResultOptimizationService = void 0;
class ResultOptimizationService {
    /**
     * Main optimization method that removes duplicates, filters invalid results,
     * and compresses the data structure
     */
    optimizeResults(serpResults, metaPromptResult) {
     ...
     */
    calculateRelevanceScores(results, metaPromptResult) {
        ...
        return results.map(result => {
            ...
            score *= engineWeights[result.engine] || 1.0;
     ...
     */
    sortAndLimitResults(results, limit = 20) {
        return results
     ...
     */
    extractTargetKeywords(metaPromptResult) {
        const keywords = [];
        // Entity A full name
        ...
        keywords.push('partnership', 'collaboration', 'cooperation', 'agreement', 'contract', '合作', '伙伴', '协议', '合同', 'alliance', 'joint venture');
        return keywords;
    }
    /**
...
exports.ResultOptimizationService = ResultOptimizationService;
//# sourceMappingURL=ResultOptimizationService.js.map