...
exports.WebSearchMetaPromptService = void 0;
const GeminiService_1 = require("./GeminiService");
class WebSearchMetaPromptService {
    constructor() {
        this.geminiService = new GeminiService_1.GeminiService();
    }
    async generateSearchStrategy(request) {
        ...
        try {
            ...
            const result = await this.geminiService.verifyCompanyEntity(Target_institution, Location, Risk_Entity);
            ...
            if (validationResult.isValid) {
                ...
                // Add date range and custom keyword to result if provided
                return {
                    ...result,
                    Start_Date: request.Start_Date,
                    End_Date: request.End_Date,
                    Custom_Keyword: request.Custom_Keyword,
                    Original_Risk_Entity: request.Risk_Entity
                };
            }
            else {
    ...
    getCountryCodeForLocation(location) {
...
exports.WebSearchMetaPromptService = WebSearchMetaPromptService;
//# sourceMappingURL=WebSearchMetaPromptService.js.map