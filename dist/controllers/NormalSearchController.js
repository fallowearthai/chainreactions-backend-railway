...
exports.NormalSearchController = void 0;
const GeminiNormalSearchService_1 = require("../services/GeminiNormalSearchService");
class NormalSearchController {
    constructor() {
        this.geminiService = new GeminiNormalSearchService_1.GeminiNormalSearchService();
    }
    /**
     ...
     */
    async handleNormalSearch(req, res) {
        try {
            const searchRequest = {
...
exports.NormalSearchController = NormalSearchController;
//# sourceMappingURL=NormalSearchController.js.map