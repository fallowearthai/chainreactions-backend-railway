...
exports.EntitySearchController = void 0;
const LinkupService_1 = require("../services/entity-search/LinkupService");
const responseParser_1 = require("../services/entity-search/responseParser");
class EntitySearchController {
    constructor() {
        this.linkupService = new LinkupService_1.LinkupService();
    }
    async handleEntitySearch(req, res, next) {
        try {
            const { company_name, location, exclude_domains } = req.body;
            ...
            if (searchResult.success) {
                ...
                const parsedResponse = responseParser_1.ResponseParser.processLinkupResponse(searchResult.data);
                // Extract clean data for frontend (matches N8N output format)
                const responseData = responseParser_1.ResponseParser.extractCleanData(parsedResponse);
    ...
    async testLinkupConnection(req, res, next) {
        try {
...
exports.EntitySearchController = EntitySearchController;
//# sourceMappingURL=EntitySearchController.js.map