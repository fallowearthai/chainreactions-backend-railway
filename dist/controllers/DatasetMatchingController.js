...
const DatasetMatchingService_1 = require("../services/dataset-matching/src/services/DatasetMatchingService");
const ResponseFormatter_1 = require("../services/dataset-matching/src/utils/ResponseFormatter");
const ErrorHandler_1 = require("../services/dataset-matching/src/utils/ErrorHandler");
class DatasetMatchingController {
    constructor() {
         ...
         */
        this.handleSingleMatch = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
         ...
         */
        this.handleBatchMatch = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
            const startTime = process.hrtime();
            // Validate request body
         ...
         */
        this.handleClearCache = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
         ...
         */
        this.handleGetStats = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
         ...
         */
        this.handleHealthCheck = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
            try {
         ...
         */
        this.handleCacheWarmup = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
            const startTime = process.hrtime();
         ...
         */
        this.handleTestMatch = (0, ErrorHandler_1.asyncHandler)(async (req, res, next) => {
