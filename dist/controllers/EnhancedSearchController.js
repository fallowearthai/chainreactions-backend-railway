...
exports.EnhancedSearchController = void 0;
const WebSearchMetaPromptService_1 = require("../services/deepthinking/WebSearchMetaPromptService");
const SerpExecutorService_1 = require("../services/deepthinking/SerpExecutorService");
const ResultIntegrationService_1 = require("../services/deepthinking/ResultIntegrationService");
class EnhancedSearchController {
    constructor() {
        this.metaPromptService = new WebSearchMetaPromptService_1.WebSearchMetaPromptService();
        this.serpExecutorService = new SerpExecutorService_1.SerpExecutorService();
        this.resultIntegrationService = new ResultIntegrationService_1.ResultIntegrationService();
    }
    async enhancedSearch(req, res) {
        ...
        try {
            ...
            const finalResult = await this.resultIntegrationService.integrateAndAnalyzeOptimized(searchRequest, metaPromptResult, optimizedResults);
    ...
    async enhancedSearchStream(req, res) {
        const startTime = Date.now();
        try {
            // Set up SSE headers
            res.writeHead(200, {
            ...
            const stage2ProgressCallback = (progress, current, total) => {
                sendEvent({
                    stage: 2,
                    status: 'progress',
                    message: progress,
            ...
            const optimizedResults = await this.serpExecutorService.executeSearchStrategyOptimizedWithProgress(searchRequest, metaPromptResult, stage2ProgressCallback);
            ...
            const stage3ProgressCallback = (progress) => {
                sendEvent({
                    stage: 3,
                    status: 'progress',
                    message: progress
            ...
            let finalResult;
            try {
                finalResult = await this.resultIntegrationService.integrateAndAnalyzeOptimized(searchRequest, metaPromptResult, optimizedResults);
    ...
    async getSearchStrategy(req, res) {
        try {
            const searchRequest = this.validateSearchRequest(req.body);
...
exports.EnhancedSearchController = EnhancedSearchController;
//# sourceMappingURL=EnhancedSearchController.js.map