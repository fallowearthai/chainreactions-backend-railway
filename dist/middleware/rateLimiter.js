...
exports.getRateLimiterStats = exports.apiTestRateLimiter = exports.healthCheckRateLimiter = void 0;
/**
 ...
 */
const healthCheckRateLimiter = (req, res, next) => {
...
exports.healthCheckRateLimiter = healthCheckRateLimiter;
/**
 * Middleware for API test endpoints rate limiting
 */
const apiTestRateLimiter = (req, res, next) => {
    const identifier = req.ip || req.socket.remoteAddress || 'unknown';
...
exports.apiTestRateLimiter = apiTestRateLimiter;
/**
